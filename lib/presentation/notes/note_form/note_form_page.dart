...
import 'package:brokerage/domain/notes/note.dart';
import 'package:brokerage/injection.dart';
import 'package:brokerage/presentation/notes/note_form/misc/todo_item_presentation_classes.dart';
import 'package:brokerage/presentation/notes/note_form/widgets/add_todo_tile_widget.dart';
import 'package:brokerage/presentation/notes/note_form/widgets/body_field_widget.dart';
import 'package:brokerage/presentation/notes/note_form/widgets/color_field_widget.dart';
import 'package:brokerage/presentation/notes/note_form/widgets/todo_list_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: BlocBuilder<NoteFormBloc, NoteFormState>(
            ...
            buildWhen: (previousState, state) =>
                state.isEditing != previousState.isEditing,
            builder: (context, state) =>
                Text(state.isEditing ? '编辑便签' : '创建便签'),
          ),
          actions: <Widget>[
            Builder(
              builder: (context) {
        ...
        body: BlocBuilder<NoteFormBloc, NoteFormState>(
          ...
          buildWhen: (previousState, state) =>
              state.showErrorMessages != previousState.showErrorMessages,
          builder: (context, state) {
